                    ...
                    {data.map((product)=>(
                        <div key={product._id} className="group relative">
                            <div className="aspect-square w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75 lg:h-80">
                                ...
                                <Image src={product.imagesUrl} alt="Product image" className="w-full h-full object-cover object-center lg:h-full lg:w-full duration-200" width={300} height={300} />
                            </div>
                            <div className="mt-4 flex justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-small text-gray-500">{product.categoryName}</p>
                                </div>
